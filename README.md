...
The password of the Steam Account that owns the workshop item. Alternatively, set `configVdf`.

#### totp

A valid Steam Guard TOTP code. Only required if Steam Guard is enabled for the account. Alternatively, set `configVdf`.
